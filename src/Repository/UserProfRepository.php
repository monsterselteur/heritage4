...
/**
 * @extends ServiceEntityRepository<UserProf>
 *
 ...
 */
class UserProfRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    public function add(UserProf $entity, bool $flush = false): void
    {
    ...
    public function remove(UserProf $entity, bool $flush = false): void
    {
